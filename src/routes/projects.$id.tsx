...
function ProjectDetail() {
  ...
  const progress = projectProgress(tasks, sections, project.id);
      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {project.type} · Cliente: {client?.name ?? "—"}
          </p>
        </div>
                ...
                <CardContent className="space-y-2">
                  ...
                  {projectTasks.map((t) => {
                    ...
                    return (
                      <div
                        key={t.id}
                        className="flex items-center gap-3 text-sm border rounded-md p-2.5"
                      >
                        <Checkbox
                          checked={done}
                          onCheckedChange={(c) =>
                        ...
                        >
                          ...
                          <p className="text-xs text-muted-foreground mt-0.5">
                            Prazo {formatDate(t.dueDate)} · {sectionName}
                          </p>
                        </button>
                ...
                <CardContent className="space-y-2">
                  {installments.length === 0 && (
                    <p className="text-sm text-muted-foreground">
                      Nenhuma parcela cadastrada. Edite o projeto para gerar o parcelamento.
                    </p>
                  )}
                  {installments.map((t) => (
                    <div
                    ...
                    >
                      <span>
                        {t.installment}ª parcela · venc. {formatDate(t.date)}
                      </span>
